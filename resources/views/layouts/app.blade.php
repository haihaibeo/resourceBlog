                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <form class="mr-2 my-auto w-100 d-inline-block order-1" method="GET" action="/search">
                            <div class="input-group">
                                <input type="text" class="form-control border border-right-0 shadow-none" name="searchTerm" placeholder="Search by title/subtitle">
                                <span class="input-group-append">
                                    <button class="btn btn-outline border border-left-0" type="submit">
        ...
        <div class="container">
            ...
            <footer class="pt-4 my-md-5 pt-md-5 border-top">
                <div class="row justify-content-between">
                    <div class="col-4">
                        <small class="d-block mb-3 text-muted">ООО Boring Company</small>
