...
@section('content')
    <div class="container">
        <form class="form" method="POST" action="/blog/{{$blog->id}}" enctype="multipart/form-data">
            @method('PATCH')
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="subtitle" type="text" class="form-control @error('subtitle') is-invalid @enderror" name="subtitle" value="{{ old('subtitle') ?? $blog->subtitle}}" required autocomplete="subtitle" autofocus>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <textarea class="form-control" value="{{ $blog->blogText }}" id="textArea" placeholder="Blog content..." required rows="5" name="blogText"></textarea>
